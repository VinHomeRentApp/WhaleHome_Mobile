...
const BodyCommentField = () => {
  return (
    <View style={styles.reviewContainer}>
      <View>
        <TextComponent styles={styles.reviewTitle} content='Comments' />
      </View>
      {/* Review Field */}
      ...
      <Pressable style={({ pressed }) => [styles.viewAllButtonContainer, pressed && styles.activeButton]}>
        <TextComponent styles={styles.viewAllText} content='View All Comments' />
      </Pressable>
    </View>
  );
};

export default BodyCommentField;

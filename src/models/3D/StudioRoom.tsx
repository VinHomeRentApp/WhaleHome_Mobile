...
export default function StudioRoom(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(require('../../assets/roomModel/3-Bedroom.glb')) as GLTFResult;
  return (
...
useGLTF.preload(require('../../assets/roomModel/3-Bedroom.glb'));
